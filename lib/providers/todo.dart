...
import 'package:flutter_todo_api/utils/exceptions.dart';
import 'package:flutter_todo_api/utils/todo_response.dart';
import 'package:flutter_todo_api/services/api.dart';
...
class TodoProvider with ChangeNotifier {
  ...
  List<Todo> _openTodos = <Todo>[];
  List<Todo> _closedTodos = <Todo>[];
